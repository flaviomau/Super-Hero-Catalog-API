...
router.delete('/:_id',  middlewareAuth({route: 8}), SuperPowerController.delete.bind(SuperPowerController))
router.put('/:_id',     middlewareAuth({route: 9}), SuperPowerController.update.bind(SuperPowerController))
